...
<body>
    ...
    <div class="flex-container">
        ...
        <select id="team_3v3">
            ...
            <option disabled value="protectThePresidentC">Protect the President Type C</option>
    ...
    <div class="flex-container">
        <ol>
            ...
            <p id="showGods"></p>
            <p>You will get duplicates until I fix it, but Enjoy! JB Rushed me! If you know, you know.</p>
